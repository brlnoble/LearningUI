...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(171, 60);
			...
			this->label2->Location = System::Drawing::Point(271, 60);
			...
			this->label3->Location = System::Drawing::Point(366, 60);
			...
			this->label4->Location = System::Drawing::Point(464, 60);
			...
			this->label5->Location = System::Drawing::Point(567, 60);
			...
			this->label6->Location = System::Drawing::Point(669, 60);
			...
			this->label7->Location = System::Drawing::Point(783, 60);
			...
			// button1, Generate
			// 
			this->button1->Location = System::Drawing::Point(231, 139);
			...
			// button2, Reset
			// 
			this->button2->Location = System::Drawing::Point(697, 139);
			...
			this->pictureBox1->Size = System::Drawing::Size(126, 122);
			...
			this->ClientSize = System::Drawing::Size(899, 253);
